...
const AddProductForm = () => {
  ...
  return (
    <div className="d-flex justify-content-center my-3">
      <div className="card shadow mt-5" style={{ width: "650px", maxHeight: "300vh", height: "500px"}}>
        <h1 className="text-center mb-2 mt-3 fs-3">Añadir Nuevo Producto</h1>

        <form className="bg-light mb-3 py-0 justify-content-center bg-light"onSubmit={handleSubmit}>
          <div className="mb-2">
